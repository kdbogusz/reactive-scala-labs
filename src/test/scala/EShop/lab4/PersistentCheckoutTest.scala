...
class PersistentCheckoutTest
  ...
  it should "be in cancelled state after cancel message received in selectingDelivery State despite restart" in {
    val resultStartCheckout = eventSourcedTestKit.runCommand(StartCheckout)
  ...
  it should "be in cancelled state after expire checkout timeout in selectingDelivery state despite restart" in {
    val resultStartCheckout = eventSourcedTestKit.runCommand(StartCheckout)
  ...
  it should "complete entire lifespan depsite multiple restarts" in {
    val resultStartCheckout = eventSourcedTestKit.runCommand(StartCheckout)
